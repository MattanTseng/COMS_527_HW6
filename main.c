...
int main() {
	...
	// double trainingTime = (double)(doneTrainTime - startTrainTime);
	// double imageLoadTime = (double)(doneLoadTime - startLoadTime);
	...
	double inferenceTime = (double)(endTime - startTime);
